-- =============================================================================
--  VHDL instance generated by IPExpress    01/30/2023    10:12:36         
--  Filename: c200_fpga_la0_inst.vhd                                          
...
PACKAGE c200_fpga_la0_pkg IS
    COMPONENT c200_fpga_la0
    PORT (
        clk:		IN std_logic;
        ...
        trace_din:	IN std_logic_vector (37 downto 0);
        ip_enable:	IN std_logic
    );

    END COMPONENT;

END PACKAGE c200_fpga_la0_pkg;
