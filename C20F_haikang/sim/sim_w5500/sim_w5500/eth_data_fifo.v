...
/* Module Version: 5.1 */
/* E:\tools\Iscc\diamond\3.12\ispfpga\bin\nt64\scuba.exe -w -n eth_data_fifo -lang verilog -synth lse -bus_exp 7 -bb -arch sa5p00 -type ebfifo -sync_mode -depth 2048 -width 8 -no_enable -pe -1 -pf -1 -sync_reset -fill -fdc D:/programs/fpga/C200_FPGA/C200_FPGA/eth_data_fifo/eth_data_fifo.fdc  */
/* Wed May 19 16:28:06 2021 */


`timescale 1 ns / 1 ps
module eth_data_fifo (Data, Clock, WrEn, RdEn, Reset, Q, WCNT, Empty, 
    ...
    DP16KD pdp_ram_0_0_0 (.DIA17(scuba_vlo), .DIA16(scuba_vlo), .DIA15(scuba_vlo), 
        ...
        .DOB0(Q[0]))
             /* synthesis MEM_LPC_FILE="eth_data_fifo.lpc" */
    ...
    // exemplar begin
    // exemplar attribute pdp_ram_0_0_0 MEM_LPC_FILE eth_data_fifo.lpc
