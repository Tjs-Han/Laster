-- =============================================================================
--  VHDL instance generated by IPExpress    05/22/2025    18:53:09         
--  Filename: c25x_fpga_la0_inst.vhd                                          
...
PACKAGE c25x_fpga_la0_pkg IS
    COMPONENT c25x_fpga_la0
    PORT (
        clk:		IN std_logic;
        ...
        trace_din:	IN std_logic_vector (82 downto 0);
        ip_enable:	IN std_logic
    );

    END COMPONENT;

END PACKAGE c25x_fpga_la0_pkg;
