`define FIRMWARE_VERSION		32'h23102514
...
`define SET_TAIL_SWITCH			8'd35
`define GET_TAIL_SWITCH			8'd36
...
`define SET_TAIL_PARA			8'd86
`define GET_TAIL_PARA			8'd87
...
`define	SET_OPTO_SWITCH			8'd156
`define	GET_OPTO_SWITCH			8'd157
`define	SET_OPTO_DATA			8'd158
`define	GET_OPTO_DATA			8'd159

`define SET_HVCP_DATA			8'd165
`define GET_HVCP_DATA			8'd166
`define SET_DICP_DATA			8'd167
`define GET_DICP_DATA			8'd168
`define GET_DIST_COMPEN			8'd169

`define GET_CODE 				8'd180
...
`define ACK_GENERAL				8'h00
`define WRITE_DDR_CMD			8'h01
`define SAVE_FLASH_CMD			8'h02
`define READ_DDR_CMD			8'h03
`define CHECK_STATE_CMD	        8'h04

`define LOOP_SWITCH_CMD			8'h11
`define LOOP_DATA_CMD			8'h12
`define CALI_SWITCH_CMD			8'h13
`define CALI_DATA_CMD			8'h14
`define ONCE_SWITCH_CMD			8'h15
`define ONCE_DATA_CMD			8'h16

`define LOAD_PARA_FACT			8'h31
`define SAVE_PARA_FACT			8'h32