...
onbreak {resume} 
quit -sim 
cd "D:/FreeWork/df1_second_round/df1_3dprj_dev/src/ip/df1_lidar_ip/divider_24bit/divider_eval/divider_24bit/sim/modelsim/rtl"
if [file exists work] { 
...
vsim -novopt -t 1ps divider_24bit_tb -l divider_24bit_rtl_se.log
