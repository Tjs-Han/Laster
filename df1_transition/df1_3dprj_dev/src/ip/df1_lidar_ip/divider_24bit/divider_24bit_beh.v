...
module divider_core_divider_24bit(
                  clk,
                  rstn,
                  ce, 
                  dvalid_in,
...
assign hoeb25a = 1'b0; 
generate
if(DTYPE=="UNSIGNED" && STYPE=="UNSIGNED") begin   db32863_divider_24bit #(                  .DWIDTH           (DWIDTH           ),                  .SWIDTH           (SWIDTH           ),                  .LATENCY          (LATENCY          ),                  .FAMILY           (FAMILY           ))   ne631ce         (                                    .clk              (clk              ),                  .rstn             (rstn             ),                  .ce               (pf71201               ),                  .hoeb25a               (pu8900e               ),                  .dvalid_in        (ri966c9        ),                  .numerator        (xwca3d1        ),                  .denominator      (cb8f45c      ),                                    .dvalid_out       (dvalid_out       ),                  .remainder        (remainder        ),                  .quotient         (quotient         ));
end else if(DTYPE=="UNSIGNED" && STYPE=="SIGNED") begin   by665d8_divider_24bit #(                  .DWIDTH           (QWIDTH           ),                  .SWIDTH           (RWIDTH           ),                  .LATENCY          (LATENCY          ),                  .POS_RMD          (POS_RMD          ),                  .FAMILY           (FAMILY           ))   ne631ce         (                                    .clk              (clk              ),                  .rstn             (rstn             ),                  .ce               (pf71201               ),                  .hoeb25a               (pu8900e               ),                  .dvalid_in        (ri966c9        ),                  .numerator        ({1'b0,xwca3d1} ),                  .denominator      (cb8f45c      ),                                    .dvalid_out       (dvalid_out       ),                  .remainder        (remainder        ),                  .quotient         (quotient         ));
end else if(DTYPE=="SIGNED" && STYPE=="UNSIGNED") begin   by665d8_divider_24bit #(                  .DWIDTH           (QWIDTH           ),                  .SWIDTH           (RWIDTH           ),                  .LATENCY          (LATENCY          ),                  .POS_RMD          (POS_RMD          ),                  .FAMILY           (FAMILY           ))   ne631ce         (                                    .clk              (clk              ),                  .rstn             (rstn             ),                  .ce               (pf71201               ),                  .hoeb25a               (pu8900e               ),                  .dvalid_in        (ri966c9        ),                  .numerator        (xwca3d1        ),                  .denominator      ({1'b0,cb8f45c}),                                    .dvalid_out       (dvalid_out       ),                  .remainder        (remainder        ),                  .quotient         (quotient         ));
end else begin   by665d8_divider_24bit #(                  .DWIDTH           (DWIDTH           ),                  .SWIDTH           (SWIDTH           ),                  .LATENCY          (LATENCY          ),                  .POS_RMD          (POS_RMD          ),                  .FAMILY           (FAMILY           ))   ne631ce         (                                    .clk              (clk              ),                  .rstn             (rstn             ),                  .ce               (pf71201               ),                  .hoeb25a               (pu8900e               ),                  .dvalid_in        (ri966c9        ),                  .numerator        (xwca3d1        ),                  .denominator      (cb8f45c      ),                                    .dvalid_out       (dvalid_out       ),                  .remainder        (remainder        ),                  .quotient         (quotient         ));
end
endgenerate
