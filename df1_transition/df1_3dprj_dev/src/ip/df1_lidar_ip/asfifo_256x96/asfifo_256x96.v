...
/* Module Version: 5.8 */
/* D:\TOOL\LatticeDiamond\diamond\3.13\ispfpga\bin\nt64\scuba.exe -w -n asfifo_256x96 -lang verilog -synth synplify -bus_exp 7 -bb -arch sa5p00 -type ebfifo -depth 256 -width 96 -rwidth 96 -reset_rel SYNC -pe -1 -pf -1 -fdc D:/FreeWork/df1/src/ip/df1_lidar_ip/asfifo_256x96/asfifo_256x96.fdc  */
/* Wed Nov 20 10:06:52 2024 */


`timescale 1 ns / 1 ps
module asfifo_256x96 (Data, WrClock, RdClock, WrEn, RdEn, Reset, RPReset, 
    ...
    PDPW16KD pdp_ram_0_0_2 (.DI35(Data[35]), .DI34(Data[34]), .DI33(Data[33]), 
        ...
        .CSW2(scuba_vlo), .CSW1(scuba_vlo), .CSW0(scuba_vhi), .ADR13(scuba_vlo), 
        ...
        .DO2(Q[20]), .DO1(Q[19]), .DO0(Q[18]))
             /* synthesis MEM_LPC_FILE="asfifo_256x96.lpc" */
    ...
    PDPW16KD pdp_ram_0_1_1 (.DI35(Data[71]), .DI34(Data[70]), .DI33(Data[69]), 
        ...
        .DI0(Data[36]), .ADW8(scuba_vlo), .ADW7(wptr_7), .ADW6(wptr_6), 
        .ADW5(wptr_5), .ADW4(wptr_4), .ADW3(wptr_3), .ADW2(wptr_2), .ADW1(wptr_1), 
        .ADW0(wptr_0), .BE3(scuba_vhi), .BE2(scuba_vhi), .BE1(scuba_vhi), 
        .BE0(scuba_vhi), .CEW(wren_i), .CLKW(WrClock), .CSW2(scuba_vlo), 
        .CSW1(scuba_vlo), .CSW0(scuba_vhi), .ADR13(scuba_vlo), .ADR12(rptr_7), 
        .ADR11(rptr_6), .ADR10(rptr_5), .ADR9(rptr_4), .ADR8(rptr_3), .ADR7(rptr_2), 
        .ADR6(rptr_1), .ADR5(rptr_0), .ADR4(scuba_vlo), .ADR3(scuba_vlo), 
        .ADR2(scuba_vlo), .ADR1(scuba_vlo), .ADR0(scuba_vlo), .CER(rden_i), 
        .OCER(rden_i), .CLKR(RdClock), .CSR2(scuba_vlo), .CSR1(scuba_vlo), 
    ...
    PDPW16KD pdp_ram_0_2_0 (.DI35(scuba_vlo), .DI34(scuba_vlo), .DI33(scuba_vlo), 
        ...
        .DI24(scuba_vlo), .DI23(Data[95]), .DI22(Data[94]), .DI21(Data[93]), 
        .DI20(Data[92]), .DI19(Data[91]), .DI18(Data[90]), .DI17(Data[89]), 
        ...
        .DI0(Data[72]), .ADW8(scuba_vlo), .ADW7(wptr_7), .ADW6(wptr_6), 
        .ADW5(wptr_5), .ADW4(wptr_4), .ADW3(wptr_3), .ADW2(wptr_2), .ADW1(wptr_1), 
        .ADW0(wptr_0), .BE3(scuba_vhi), .BE2(scuba_vhi), .BE1(scuba_vhi), 
        .BE0(scuba_vhi), .CEW(wren_i), .CLKW(WrClock), .CSW2(scuba_vlo), 
        .CSW1(scuba_vlo), .CSW0(scuba_vhi), .ADR13(scuba_vlo), .ADR12(rptr_7), 
        ...
        .ADR2(scuba_vlo), .ADR1(scuba_vlo), .ADR0(scuba_vlo), .CER(rden_i), 
        .OCER(rden_i), .CLKR(RdClock), .CSR2(scuba_vlo), .CSR1(scuba_vlo), 
        .CSR0(scuba_vlo), .RST(Reset), .DO35(Q[89]), .DO34(Q[88]), .DO33(Q[87]), 
        .DO32(Q[86]), .DO31(Q[85]), .DO30(Q[84]), .DO29(Q[83]), .DO28(Q[82]), 
        .DO27(Q[81]), .DO26(Q[80]), .DO25(Q[79]), .DO24(Q[78]), .DO23(Q[77]), 
        .DO22(Q[76]), .DO21(Q[75]), .DO20(Q[74]), .DO19(Q[73]), .DO18(Q[72]), 
        .DO17(), .DO16(), .DO15(), .DO14(), .DO13(), .DO12(), .DO11(), .DO10(), 
        .DO9(), .DO8(), .DO7(), .DO6(), .DO5(Q[95]), .DO4(Q[94]), .DO3(Q[93]), 
        .DO2(Q[92]), .DO1(Q[91]), .DO0(Q[90]))
             /* synthesis MEM_LPC_FILE="asfifo_256x96.lpc" */
             /* synthesis MEM_INIT_FILE="" */;
    ...
    // exemplar begin
    // exemplar attribute pdp_ram_0_0_2 MEM_LPC_FILE asfifo_256x96.lpc
    // exemplar attribute pdp_ram_0_0_2 MEM_INIT_FILE 
    // exemplar attribute pdp_ram_0_1_1 MEM_LPC_FILE asfifo_256x96.lpc
    // exemplar attribute pdp_ram_0_1_1 MEM_INIT_FILE 
    // exemplar attribute pdp_ram_0_2_0 MEM_LPC_FILE asfifo_256x96.lpc
