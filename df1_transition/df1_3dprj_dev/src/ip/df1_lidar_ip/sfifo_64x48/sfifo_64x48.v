...
/* Module Version: 5.1 */
/* D:\TOOL\LatticeDiamond\diamond\3.13\ispfpga\bin\nt64\scuba.exe -w -n sfifo_64x48 -lang verilog -synth synplify -bus_exp 7 -bb -arch sa5p00 -type ebfifo -sync_mode -depth 64 -width 48 -no_enable -pe -1 -pf -1 -sync_reset -fdc D:/FreeWork/df1/df1_newprj/src/ip/df1_lidar_ip/sfifo_64x48/sfifo_64x48.fdc  */
/* Wed Feb 26 13:50:45 2025 */


`timescale 1 ns / 1 ps
module sfifo_64x48 (Data, Clock, WrEn, RdEn, Reset, Q, Empty, Full)/* synthesis NGD_DRC_MASK=1 */;
    ...
    PDPW16KD pdp_ram_0_0_1 (.DI35(Data[35]), .DI34(Data[34]), .DI33(Data[33]), 
        ...
        .ADW7(scuba_vlo), .ADW6(scuba_vlo), .ADW5(wcount_5), .ADW4(wcount_4), 
        ...
        .DO2(Q[20]), .DO1(Q[19]), .DO0(Q[18]))
             /* synthesis MEM_LPC_FILE="sfifo_64x48.lpc" */
    ...
    PDPW16KD pdp_ram_0_1_0 (.DI35(scuba_vlo), .DI34(scuba_vlo), .DI33(scuba_vlo), 
        ...
        .DI12(scuba_vlo), .DI11(Data[47]), .DI10(Data[46]), .DI9(Data[45]), 
        ...
        .ADR11(scuba_vlo), .ADR10(rcount_5), .ADR9(rcount_4), .ADR8(rcount_3), 
        ...
        .CSR0(scuba_vlo), .RST(Reset), .DO35(), .DO34(), .DO33(), .DO32(), 
        .DO31(), .DO30(), .DO29(Q[47]), .DO28(Q[46]), .DO27(Q[45]), .DO26(Q[44]), 
        .DO25(Q[43]), .DO24(Q[42]), .DO23(Q[41]), .DO22(Q[40]), .DO21(Q[39]), 
        .DO20(Q[38]), .DO19(Q[37]), .DO18(Q[36]), .DO17(), .DO16(), .DO15(), 
    ...
    // exemplar begin
    // exemplar attribute pdp_ram_0_0_1 MEM_LPC_FILE sfifo_64x48.lpc
    // exemplar attribute pdp_ram_0_0_1 MEM_INIT_FILE 
    // exemplar attribute pdp_ram_0_1_0 MEM_LPC_FILE sfifo_64x48.lpc
