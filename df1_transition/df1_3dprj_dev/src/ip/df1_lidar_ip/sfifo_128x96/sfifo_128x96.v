...
/* Module Version: 5.1 */
/* D:\TOOL\LatticeDiamond\diamond\3.13\ispfpga\bin\nt64\scuba.exe -w -n sfifo_128x96 -lang verilog -synth synplify -bus_exp 7 -bb -arch sa5p00 -type ebfifo -sync_mode -depth 128 -width 96 -no_enable -pe -1 -pf -1 -reset_rel SYNC -fdc D:/FreeWork/df1/src/ip/df1_lidar_ip/sfifo_128x96/sfifo_128x96.fdc  */
/* Thu Nov 21 11:06:10 2024 */


`timescale 1 ns / 1 ps
module sfifo_128x96 (Data, Clock, WrEn, RdEn, Reset, Q, Empty, Full)/* synthesis NGD_DRC_MASK=1 */;
    ...
    PDPW16KD pdp_ram_0_0_2 (.DI35(Data[35]), .DI34(Data[34]), .DI33(Data[33]), 
        ...
        .DO2(Q[20]), .DO1(Q[19]), .DO0(Q[18]))
             /* synthesis MEM_LPC_FILE="sfifo_128x96.lpc" */
    ...
    // exemplar begin
    // exemplar attribute pdp_ram_0_0_2 MEM_LPC_FILE sfifo_128x96.lpc
    // exemplar attribute pdp_ram_0_0_2 MEM_INIT_FILE 
    // exemplar attribute pdp_ram_0_1_1 MEM_LPC_FILE sfifo_128x96.lpc
    // exemplar attribute pdp_ram_0_1_1 MEM_INIT_FILE 
    // exemplar attribute pdp_ram_0_2_0 MEM_LPC_FILE sfifo_128x96.lpc
