...
`timescale 1 ns / 1 ps
module asfifo_256x64 (Data, WrClock, RdClock, WrEn, RdEn, Reset, RPReset, 
    ...
    PDPW16KD pdp_ram_0_0_1 (.DI35(Data[35]), .DI34(Data[34]), .DI33(Data[33]), 
        ...
        .CSR0(rden_i), .RST(Reset), .DO35(Q[17]), .DO34(Q[16]), .DO33(Q[15]), 
        ...
        .DO2(Q[20]), .DO1(Q[19]), .DO0(Q[18]))
             /* synthesis MEM_LPC_FILE="asfifo_256x64.lpc" */
    ...
    PDPW16KD pdp_ram_0_1_0 (.DI35(scuba_vlo), .DI34(scuba_vlo), .DI33(scuba_vlo), 
        ...
        .DI28(scuba_vlo), .DI27(Data[63]), .DI26(Data[62]), .DI25(Data[61]), 
        ...
        .ADR2(scuba_vlo), .ADR1(scuba_vlo), .ADR0(scuba_vlo), .CER(scuba_vhi), 
        .OCER(scuba_vhi), .CLKR(RdClock), .CSR2(scuba_vlo), .CSR1(scuba_vlo), 
        .CSR0(rden_i), .RST(Reset), .DO35(Q[53]), .DO34(Q[52]), .DO33(Q[51]), 
    ...
    // exemplar begin
    // exemplar attribute pdp_ram_0_0_1 MEM_LPC_FILE asfifo_256x64.lpc
    // exemplar attribute pdp_ram_0_0_1 MEM_INIT_FILE 
    // exemplar attribute pdp_ram_0_1_0 MEM_LPC_FILE asfifo_256x64.lpc
