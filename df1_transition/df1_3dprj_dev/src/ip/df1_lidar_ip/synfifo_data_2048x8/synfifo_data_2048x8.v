...
/* Module Version: 5.1 */
/* D:\TOOL\LatticeDiamond\diamond\3.13\ispfpga\bin\nt64\scuba.exe -w -n synfifo_data_2048x8 -lang verilog -synth synplify -bus_exp 7 -bb -arch sa5p00 -type ebfifo -sync_mode -depth 2048 -width 8 -no_enable -pe -1 -pf -1 -sync_reset -fdc D:/FreeWork/df1_demo/phy_develop/src/ip/df1_lidar_ip/synfifo_data_2048x8/synfifo_data_2048x8.fdc  */
/* Mon Oct 21 19:26:02 2024 */


`timescale 1 ns / 1 ps
module synfifo_data_2048x8 (Data, Clock, WrEn, RdEn, Reset, Q, Empty, 
    ...
    DP16KD pdp_ram_0_0_0 (.DIA17(scuba_vlo), .DIA16(scuba_vlo), .DIA15(scuba_vlo), 
        ...
        .DOB0(Q[0]))
             /* synthesis MEM_LPC_FILE="synfifo_data_2048x8.lpc" */
    ...
    // exemplar begin
    // exemplar attribute pdp_ram_0_0_0 MEM_LPC_FILE synfifo_data_2048x8.lpc
