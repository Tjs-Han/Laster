...
/* Module Version: 5.1 */
/* D:\TOOL\LatticeDiamond\diamond\3.13\ispfpga\bin\nt64\scuba.exe -w -n fifo_mac_frame_2048x10 -lang verilog -synth synplify -bus_exp 7 -bb -arch sa5p00 -type ebfifo -sync_mode -depth 2048 -width 10 -no_enable -pe -1 -pf -1 -sync_reset -fdc D:/FreeWork/df1_demo/phy_develop/src/ip/df1_lidar_ip/fifo_mac_frame_2048x10/fifo_mac_frame_2048x10.fdc  */
/* Tue Oct 15 10:38:00 2024 */


`timescale 1 ns / 1 ps
module fifo_mac_frame_2048x10 (Data, Clock, WrEn, RdEn, Reset, Q, Empty, 
    Full)/* synthesis NGD_DRC_MASK=1 */;
    input wire [9:0] Data;
    input wire Clock;
    input wire WrEn;
    input wire RdEn;
    ...
    DP16KD pdp_ram_0_0_1 (.DIA17(scuba_vlo), .DIA16(scuba_vlo), .DIA15(scuba_vlo), 
        ...
        .DIA2(Data[2]), .DIA1(Data[1]), .DIA0(Data[0]), .ADA13(wcount_10), 
        .ADA12(wcount_9), .ADA11(wcount_8), .ADA10(wcount_7), .ADA9(wcount_6), 
        ...
        .DIB1(scuba_vlo), .DIB0(scuba_vlo), .ADB13(rcount_10), .ADB12(rcount_9), 
        .ADB11(rcount_8), .ADB10(rcount_7), .ADB9(rcount_6), .ADB8(rcount_5), 
        ...
        .DOB11(), .DOB10(), .DOB9(), .DOB8(Q[8]), .DOB7(Q[7]), .DOB6(Q[6]), 
        .DOB5(Q[5]), .DOB4(Q[4]), .DOB3(Q[3]), .DOB2(Q[2]), .DOB1(Q[1]), 
        .DOB0(Q[0]))
             /* synthesis MEM_LPC_FILE="fifo_mac_frame_2048x10.lpc" */
    ...
    DP16KD pdp_ram_0_1_0 (.DIA17(scuba_vlo), .DIA16(scuba_vlo), .DIA15(scuba_vlo), 
        ...
        .DIA2(scuba_vlo), .DIA1(scuba_vlo), .DIA0(Data[9]), .ADA13(wcount_10), 
        .ADA12(wcount_9), .ADA11(wcount_8), .ADA10(wcount_7), .ADA9(wcount_6), 
        .ADA8(wcount_5), .ADA7(wcount_4), .ADA6(wcount_3), .ADA5(wcount_2), 
        .ADA4(wcount_1), .ADA3(wcount_0), .ADA2(scuba_vlo), .ADA1(scuba_vlo), 
        .ADA0(scuba_vlo), .CEA(wren_i), .OCEA(wren_i), .CLKA(Clock), .WEA(scuba_vhi), 
    ...
    FD1S3BX FF_25 (.D(empty_d), .CK(Clock), .PD(Reset), .Q(empty_i))
             /* synthesis GSR="ENABLED" */;

    FD1S3DX FF_24 (.D(full_d), .CK(Clock), .CD(Reset), .Q(full_i))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_23 (.D(iwcount_0), .SP(wren_i), .CK(Clock), .CD(Reset), .Q(wcount_0))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_22 (.D(iwcount_1), .SP(wren_i), .CK(Clock), .CD(Reset), .Q(wcount_1))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_21 (.D(iwcount_2), .SP(wren_i), .CK(Clock), .CD(Reset), .Q(wcount_2))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_20 (.D(iwcount_3), .SP(wren_i), .CK(Clock), .CD(Reset), .Q(wcount_3))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_19 (.D(iwcount_4), .SP(wren_i), .CK(Clock), .CD(Reset), .Q(wcount_4))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_18 (.D(iwcount_5), .SP(wren_i), .CK(Clock), .CD(Reset), .Q(wcount_5))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_17 (.D(iwcount_6), .SP(wren_i), .CK(Clock), .CD(Reset), .Q(wcount_6))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_16 (.D(iwcount_7), .SP(wren_i), .CK(Clock), .CD(Reset), .Q(wcount_7))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_15 (.D(iwcount_8), .SP(wren_i), .CK(Clock), .CD(Reset), .Q(wcount_8))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_14 (.D(iwcount_9), .SP(wren_i), .CK(Clock), .CD(Reset), .Q(wcount_9))
             /* synthesis GSR="ENABLED" */;
    ...
    FD1P3DX FF_1 (.D(ircount_10), .SP(rden_i), .CK(Clock), .CD(Reset), .Q(rcount_10))
             /* synthesis GSR="ENABLED" */;

    FD1P3DX FF_0 (.D(ircount_11), .SP(rden_i), .CK(Clock), .CD(Reset), .Q(rcount_11))
             /* synthesis GSR="ENABLED" */;
    ...
    CCU2C g_cmp_5 (.A0(fcount_10), .A1(fcount_11), .B0(wren_i), .B1(wren_i_inv), 
        .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), .D1(scuba_vhi), 
    ...
    CCU2C w_ctr_5 (.A0(wcount_10), .A1(wcount_11), .B0(scuba_vlo), .B1(scuba_vlo), 
        .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), .D1(scuba_vhi), 
        .CIN(co4_3), .S0(iwcount_10), .S1(iwcount_11), .COUT(co5_1));
    ...
    CCU2C r_ctr_5 (.A0(rcount_10), .A1(rcount_11), .B0(scuba_vlo), .B1(scuba_vlo), 
        .C0(scuba_vhi), .C1(scuba_vhi), .D0(scuba_vhi), .D1(scuba_vhi), 
        .CIN(co4_4), .S0(ircount_10), .S1(ircount_11), .COUT(co5_2));
    ...
    // exemplar begin
    // exemplar attribute pdp_ram_0_0_1 MEM_LPC_FILE fifo_mac_frame_2048x10.lpc
    // exemplar attribute pdp_ram_0_0_1 MEM_INIT_FILE 
    // exemplar attribute pdp_ram_0_1_0 MEM_LPC_FILE fifo_mac_frame_2048x10.lpc
