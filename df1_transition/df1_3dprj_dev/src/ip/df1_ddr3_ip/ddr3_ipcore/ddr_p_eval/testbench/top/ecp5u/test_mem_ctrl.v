...
`define ddr3_ipcore_READ 4'b0001
`define ddr3_ipcore_WRITE 4'b0010
`define ddr3_ipcore_READA 4'b0011
`define ddr3_ipcore_WRITEA 4'b0100
`define ddr3_ipcore_PDOWN_ENT 4'b0101
`define ddr3_ipcore_LMR 4'b0110
`define ddr3_ipcore_SEL_REF_ENT 4'b1000
`define ddr3_ipcore_SEL_REF_EXIT 4'b1001
`define ddr3_ipcore_PDOWN_EXIT 4'b1011
`define ddr3_ipcore_ZQ_LNG 4'b1100
`define ddr3_ipcore_ZQ_SHRT 4'b1101
...
parameter c = `ddr3_ipcore_REFCLK_PERIOD_BY2;  // PLL_FIN is refclk to PLL.  unit of c is ps.
...
ddr3_sdram_mem_top_ddr3_ipcore U1_ddr_sdram_mem_top (
...
//`endif 
  ...
  `define ddr3_ipcore_DIMM_CS_WIDTH 1
//--------------- DIMM 0 --------------------------------------

   ddr3_dimm_16_ddr3_ipcore U0_ddr3_dimm (
       .rst_n              (ddr_resetn),
       .ddr_dq             (ddr_dq),
       .ddr_dqs            (ddr_dqs),
       ...
       .ddr_cas_n          (ddr_cas_n),
       .ddr_we_n           (ddr_we_n),
       .ddr_cs_n           (ddr_cs_n[`ddr3_ipcore_DIMM_CS_WIDTH-1:0]),
       .ddr_clk            (ddr_clk[`ddr3_ipcore_DIMM_CS_WIDTH-1:0]),
       .ddr_clk_n          (~ddr_clk[`ddr3_ipcore_DIMM_CS_WIDTH-1:0]),
       .ddr_cke            (ddr_cke[`ddr3_ipcore_DIMM_CS_WIDTH-1:0]),
       .ddr_odt            (ddr_odt[`ddr3_ipcore_DIMM_CS_WIDTH-1:0])
   );
...
monitor_ddr3_ipcore U1_monitor (
    .clk                       (clk),
    .mem_clk                   (ddr_clk[0]),
    .rst_n                     (rst_n),
    .endoftest                 (endoftest),
...
odt_watchdog_ddr3_ipcore U1_odt_watchdog (
    .mem_clk                   (ddr_clk[0]),
    .rst_n                     (rst_n),
    .ddr_cke                   (ddr_cke[0]),
    .ddr_cs_n                  (ddr_cs_n[0:0]),
