...
module ddr3_sdram_mem_top_ddr3_ipcore (
...
input   [1:0]                data_mask;
output  [4:0]               read_data /* synthesis syn_useioff = 0 */;
...
reg     [4:0]                read_data_int_r; 
reg     [4:0]                read_data_int_r1; 
reg     [4:0]                read_data_int_r2; 
...
always @(negedge rst_n or posedge sclk) begin
   if (!rst_n) begin 
      ...
      read_data_int_r        <= {4{1'b0}};
      read_data_int_r1       <= {4{1'b0}};
      read_data_int_r2       <= {4{1'b0}};
   end    
   else begin
...
ddr_clks_ddr3_ipcore U1_clocking (
   //inputs
   .rst_n              (rst_n),
   .clk_in             (clk_in), 
   .dll_update         (dll_update),
