-- =============================================================================
--  VHDL instance generated by IPExpress    11/15/2024    16:39:20         
--  Filename: ddr3_demo_la0_inst.vhd                                          
...
PACKAGE ddr3_demo_la0_pkg IS
    COMPONENT ddr3_demo_la0
    PORT (
        clk:		IN std_logic;
        ...
        trace_din:	IN std_logic_vector (190 downto 0);
        ip_enable:	IN std_logic
    );

    END COMPONENT;

END PACKAGE ddr3_demo_la0_pkg;
